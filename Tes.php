...
// GOC - WDT -TC4 - KBW - ACT - DAN LAIN LAIN
// Author By : Assembly
// bug report : 085242505224
function disable_ob(){
...
print "$red                   Coded by Assembly\n";
print "$white                   blog : http://sebuahcaraterbaik.blogspot.com\n";
print "$white                   contact : 085242505224\n";
print "$white                   usage: php namafile.php \n";
print "$white                   Thanks To :  GOLDEN OFFICIAL CYBER - TC4 - CLS - WDT\n";
print "$white        [ ************************************************************************* ]\n\n
...
Author tools mass notifier : Assembly
$white======================================\n";
...
@system("sleep 4");
echo "\ncontact : 085242505224\n";
echo "fb : Utba Langkeke'ts\n";
}else{
